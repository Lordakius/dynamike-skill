...
var handlers = {
    'LaunchRequest': function () {
        //TODO:locate this somewhere else
        welcomeOutput = "Hallo, geht es Dir gut";
        welcomeReprompt = "this is a reprompt";
        this.emit(':ask', welcomeOutput, welcomeReprompt);
        var testSpeechOutput = "this is test output";
        this.emit(':tell', testSpeechOutput);
    },
